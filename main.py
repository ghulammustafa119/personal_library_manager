...
class BookCollection:
    ...
    def show_all_books(self):
        ...
        print(f"\nShowing {len(self.book_list)} books:\n")
    ...
    def show_reading_progress(self):
        ...
        print(f"Books completed: {completed_books} out of {total_books} ({completion_rate:.2f}%)")
    ...
    def start_application(self):
        while True:
            ...
            print("7. Exit")
            user_choice = input("Please choose an option from (1-7): ").strip().lower()
            ...
            if user_choice in ["1"]:
                ...
                self.update_book()
            elif user_choice in ["5"]:
                self.show_all_books()
            elif user_choice in ["6"]:
                self.show_reading_progress()
            elif user_choice in ["7", "exit", "q"]:
